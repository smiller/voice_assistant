  ...
  describe "#respond" do
    ...
    context "with an unknown command" do
      it "returns synthesized audio of the fallback message" do
        ...
        expect(result).to eq(audio_bytes)
        expect(tts_client).to have_received(:synthesize)
          .with(text: "Sorry, I didn't understand that.  Please see the list of commands for voice commands I will understand.", voice_id: "voice123")
      end
      ...
      it "returns 'Sorry' when error is present but not :replacement_phrase_taken" do
        ...
        expect(tts_client).to have_received(:synthesize)
          .with(text: "Sorry, I didn't understand that.  Please see the list of commands for voice commands I will understand.", voice_id: user.elevenlabs_voice_id)
      end
    end
