...
ActiveRecord::Schema[8.1].define(version: 2026_02_26_061610) do
  ...
  create_table "command_aliases", force: :cascade do |t|
    ...
    t.index "user_id, lower((phrase)::text)", name: "index_command_aliases_on_user_id_and_lower_phrase", unique: true
  ...
  create_table "looping_reminders", force: :cascade do |t|
    ...
    t.integer "job_epoch", default: 0, null: false
  ...
  create_table "pending_interactions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id", "expires_at"], name: "index_pending_interactions_on_user_id_and_expires_at"
